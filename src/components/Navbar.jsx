...
const Navbar = () => {
  ...
  return (
    <div className="px-8 lg:px-28 md:px-10 bg-slate-800 h-16 fixed top-0 w-full left-0 flex items-center justify-between z-50">
      <div className="font-semibold text-xl text-gray-50 cursor-pointer">
        <Link to="/">
          <span className="text-teal-500">Skill</span> Up
        </Link>
      </div>
      <div className={`${toggle ? ' scale-100 ' : 'hidden scale-0'} flex transition-transform  lg:w-2/5 md:w-1/2 w-full absolute md:relative top-16  bg-slate-700 left-0 h-96 md:flex-row md:bg-transparent md:top-0 flex-col py-8 text-gray-50 md:flex items-center justify-between md:scale-100`}>
        <NavLink
    ...
    <label htmlFor="Toggle1" className="inline-flex items-center space-x-3 cursor-pointer text-gray-100">
